...
export function MailCompose({ toggleComposeForm }) {
    ...
    function handleChange({ target }) {
        ...
        setComposeMail(prevComposeMail => ({ ...prevComposeMail, [field]: value }))
    ...
    function onSendMail(ev) {
        ...
        mailService.save(newComposeMail)
            .then(composeMail => {
    ...
    return (
        <form onSubmit={onSendMail} className="compose-form">
            ...
            <label htmlFor="to">
                <input valule={to} onChange={handleChange} type="mail" name="to" placeholder="Recipients"></input>
            </label>
            <label htmlFor="subject">
                <input valule={subject} onChange={handleChange} type="text" name="subject" placeholder="Subject"></input>
            </label>
            <label htmlFor="body">
                <input valule={body} onChange={handleChange} type="text" name="body" placeholder="Write something.."></input>
            </label>
